...
// SetpointService updates the durable room setting before exposing the new
// value to the in-memory view.
...
// Set changes the setpoint of a room. The new value only becomes visible after
